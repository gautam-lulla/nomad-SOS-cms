/**
 * Programming Page Template
 *
 * Renders the Programming page with hero, intro section,
 * events grid with pagination, FAQ, and Instagram feed.
 */

import { FAQAccordion, InstagramFeed } from "@/components/blocks";
import { Button } from "@/components/ui";
import Image from "next/image";
import type { ProgrammingTemplateProps } from "./types";

export function ProgrammingTemplate({ slug, pageContent, instagramContent }: ProgrammingTemplateProps) {
  const { hero, intro, events, pagination, faq } = pageContent;
