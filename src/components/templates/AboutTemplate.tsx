 ...
 * About Page Template
 *
 * Renders the About page with hero, heritage section, quote,
 * team grid, awards carousel, FAQ, and Instagram feed.
 */
...
export function AboutTemplate({ slug, pageContent, instagramContent }: AboutTemplateProps) {
  const { hero, heritage, quote, fullWidthImage, team, awards, faq } = pageContent;
