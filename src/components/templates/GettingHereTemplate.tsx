/**
 * Getting Here Page Template
 *
 * Renders the Getting Here page with hero gallery, contact info,
 * stylized map, FAQ, and Instagram feed.
 */

import { FAQAccordion, InstagramFeed } from "@/components/blocks";
import Image from "next/image";
import type { GettingHereTemplateProps } from "./types";

export function GettingHereTemplate({
  slug,
  pageContent,
  instagramContent,
  siteSettings,
}: GettingHereTemplateProps) {
  const { hero, location, info, gallery, map, faq } = pageContent;
  ...
  return (
    <>
      ...
      <section className="relative h-[400px] md:h-[600px] lg:h-[720px] w-full overflow-hidden bg-map-background">
        ...
        {siteSettings?.footer?.wordmarkImage && (
