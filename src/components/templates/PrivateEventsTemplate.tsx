 ...
 *
 * Renders the Private Events page with hero, gallery,
 * contact form, FAQ, and Instagram feed.
 */
...
import type { PrivateEventsTemplateProps } from "./types";
import { PrivateEventsForm } from "@/app/private-events/private-events-form";

export function PrivateEventsTemplate({ slug, pageContent, instagramContent }: PrivateEventsTemplateProps) {
  const { hero, gallery, form, faq } = pageContent;
